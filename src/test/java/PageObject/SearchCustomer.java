...
public class SearchCustomer {
	...
	public SearchCustomer setemail(String email1) {	
		...
		ExtentLogger.pass("Email is entered");
		return this;		
	}
	...
	public SearchCustomer clicksearch() {		
		...
		ExtentLogger.pass("Search btn  is clicked");
		return this;		
	}
	...
	public boolean searchbyEmail(String email) {
		...
		for(int i=1;i<=rownum();i++ ) {
			...
			if(email.equals(value)) {
				...
				ExtentLogger.pass("Emmail  found in the table");
				break;
			}else {
				LOGGER.info("Email is not found in the table");
				ExtentLogger.pass("Email not  found in the table");
			}
		}
		return flag;
	}
	...
	public boolean searchbyname(String name) {
		...
		for(int i=1;i<=rownum();i++ ) {
			...
			if(name.equals(namevalue)) {
				...
				ExtentLogger.pass("name  is found in th table");
				break;
			}else {
				LOGGER.info("Name is not found in the table");
				ExtentLogger.pass("Name is  not found in the table");
			}
		}
		return flag;
	}
